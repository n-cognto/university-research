...
2023-01-01T02:00:00Z,15.8,61"""
    ...
    if form.is_valid():
        ...
        try:
            ...
            csv_file.seek(0)
            json_output = csv_to_time_series_json(
                csv_file, "timestamp", ["temperature", "humidity"]
            )
...
def test_json_upload_workflow():
    ...
    json_content = {
        ...
        "metadata": {"source": "weather_station_1", "location": "Test Location"},
    }
...
def run_integration_tests():
    ...
    tests = [test_csv_upload_workflow, test_json_upload_workflow]
