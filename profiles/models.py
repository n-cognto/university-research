...
class Profile(models.Model):
    ...
    department = models.CharField(
        max_length=100, blank=True, null=True, help_text="Department"
    )
    research_interests = models.TextField(
        blank=True, null=True, help_text="Research interests"
    )
    ...
    location = models.CharField(
        max_length=100, blank=True, null=True, help_text="Location"
    )

    # Social/professional links
    linkedin = models.URLField(blank=True, null=True, help_text="LinkedIn profile URL")
    scholar = models.URLField(
        blank=True, null=True, help_text="Google Scholar profile URL"
    )
